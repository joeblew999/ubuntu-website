...
NATS JetStream is our only external dependency. Synadia (the company behind NATS) maintains SOC 2 Type II certification.
...
- [View Synadia SOC 2 Type II Report (PDF) →](/doc/synadia-soc2-type2-report.pdf)
