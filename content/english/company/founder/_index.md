---
title: "Gerard Webb"
meta_title: "Gerard Webb - Founder | Ubuntu Software"
description: "Meet Gerard Webb, founder of Ubuntu Software. 25 years building real-time distributed systems for global enterprises."
draft: false
aliases:
  - "/company/team/"
  - "/company/founder/gerard-webb/"
...
### Security Architect at ECDC

As Security Architect at the European Centre for Disease Prevention and Control (2012-2017) in Stockholm, Gerard was responsible for all security work at the EU agency that protects 500 million people from infectious diseases.

ECDC operates the European Surveillance System (TESSy), collecting sensitive epidemiological data on 52 communicable diseases from 27+ EU member states. The security challenge: protecting critical public health infrastructure while enabling real-time data sharing between national health authorities across Europe.

This role demanded systems thinking at continental scale—threat modeling across organizational boundaries, secure architecture for multi-tenant data systems, and incident response planning for infrastructure that governments depend on during outbreaks.

---

### Earth Observation at European Climate Foundation

Work with the European Climate Foundation (2017-2021) brought satellite imagery and Earth observation into focus. The project involved building systems to process and analyze remote sensing data—tracking environmental changes through pollution monitoring, methane detection, and atmospheric analysis.

Four years of Golang development, working with satellite data pipelines and visualization systems. The technical challenge: taking massive amounts of geospatial data from multiple satellite sources and making it actionable.

This work reinforced a core principle: the same spatial reasoning that works for buildings and factories also applies at planetary scale. Geometry is geometry, whether you're tracking a component on a factory floor or monitoring emissions from orbit.
...
- **Bluesky:** [@ubuntusoftware.net](https://bsky.app/profile/ubuntusoftware.net)

---

## More About Us

[Experience]({{< relref "/company/experience" >}}) — 25 years of mission-critical systems for global enterprises.

[Advisors]({{< relref "/company/advisors" >}}) — Industry leaders who collaborate with us.

[Contact]({{< relref "/contact" >}}) — Get in touch.
